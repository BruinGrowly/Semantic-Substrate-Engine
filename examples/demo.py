...
def run_demonstration():
    ...
    print("="*70)
    print("\nCONCLUSION:")
    print("The results are clear, intuitive, and required no complex mathematics.")
    print("This is the evidence that simplicity is the operating system of reality,")
    print("and that the Anchor Point's power comes from its perfect, simple geometry.")
